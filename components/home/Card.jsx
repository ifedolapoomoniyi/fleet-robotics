    ...
    <div className="p-6 flex flex-row gap-5 mt-10 relative">
      ...
      {steps.map((step, key) => (
        <div className="relative w-[300px] group transition-all duration-500" key={key}>
          ...
          {/* content */}
          <div className="rounded-r-lg rounded-b text-white transition-all duration-500 group-hover:bg-[#FF3604] flex flex-col justify-between h-[300px] relative">
            <div className="absolute left-4 w-2.5 h-2.5 inline-block mix-blend-difference bg-orange-600 border-[1.33px]"></div>
            <div
              className={`font-semibold flex flex-row rounded-tr gap-2 justify-between p-4 h-[100px] border border-gray-800 border-b-0 ${
