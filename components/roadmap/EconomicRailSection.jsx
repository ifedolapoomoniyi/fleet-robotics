...
export const EconomicRailSection = () => {
  return (
    <section className="relative  bg-[url('/images/what-we-do-bg.svg')] bg-contain  relative w-full h-[300px] md:h-[700px] lg:h-[700.67px] overflow-hidden">
      ...
      {/* <img
        className="absolute top-32 md:top-48 lg:top-[273px] left-0 w-full h-80 md:h-96 lg:h-[593px] object-cover"
        alt="Group"
        src="/group-2147257444.png"
      /> */}
      ...
      <div className="  absolute cursor-pointer bottom-4 md:bottom-8  left-1/2 transform -translate-x-1/2 w-48 md:w-[261px] h-16 md:h-[82px] flex flex-col gap-[0.1px]">
        <img
