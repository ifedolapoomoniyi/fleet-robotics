...
const Page = () => {
    return (
        <main className="overflow-hidden w-full flex flex-col relative min-h-screen text-white">
            <section className='bg-linear-0 h-[100%] from-transparent via-[#eb2f01]/20 to-transparent relative'>
                ...
                <div className="relative z-10">
                    <h1 className='font-black font-allianceNo2 text-3xl sm:text-4xl lg:text-6xl text-center mt-[80px] md:mt-[120px] w-full'>
