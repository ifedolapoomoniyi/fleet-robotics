...
const HeroTechnology = () => {
	...
	return (
		<section className="relative w-full min-h-screen overflow-hidden bg-[url('/images/technology/tech-hero-bg.png')] bg-cover bg-top">
			<div className="absolute z-[2] inset-0 bg-black/60"></div>
			{!videoFailed ? (
				<>
					<video
                   ...
                   min-h-[200px] sm:min-h-[300px] md:min-h-[400px] lg:min-h-[500px]"
					...
					>
						<source
							src="/images/technology/mobile-hero-vid.mp4"
							type="video/mp4"
						/>
						Your browser does not support the video tag.
					</video>
