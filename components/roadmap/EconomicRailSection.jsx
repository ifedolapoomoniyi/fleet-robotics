...
export const EconomicRailSection = () => {
	return (
		<section className="relative bg-[url('/images/what-we-do-bg.svg')] bg-cover bg-center  relative w-full min-h-[80vh] md:min-h-[90vh] overflow-hidden">
			...
			<div className="absolute top-1/3 md:top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-16 md:-translate-y-24 lg:-translate-y-[130px] flex flex-col items-center gap-8 md:gap-12 lg:gap-[53.33px] px-4">
				<div className="flex flex-col items-center gap-6 md:gap-8 lg:gap-[33.33px] w-full">
					<h1 className="md:max-w-4xl lg:w-[886.67px] font-allianceNo2 font-normal text-5xl md:text-6xl lg:text-[85.3px] text-center mt-[-1.33px]">
          ...
          <div className="w-12 h-12 lg:w-[49.33px] lg:h-[49.33px] bg-white rounded-[2.67px] overflow-hidden flex items-center justify-center">
			...
			<div className="  absolute cursor-pointer bottom-10 md:bottom-8  left-1/2 transform -translate-x-1/2 w-48 md:w-[261px] h-16 md:h-[82px]  flex-col gap-[0.1px] flex">
				<img
					className="mx-auto w-6 h-12 md:w-[29.92px] md:h-[59.19px]"
					alt="Noun mouse scroll"
					src="/images/noun-mouse-scroll.svg"
				/>
				<div className="h-6 md:h-[23px] w-full self-center font-allianceNo2 font-normal text-white text-sm md:text-[18.7px] text-center tracking-[-0.56px] leading-[normal] pb-5">
					Scroll &amp; Explore more
				</div>
			</div>
		</section>
