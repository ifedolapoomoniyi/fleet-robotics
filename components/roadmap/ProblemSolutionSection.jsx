...
export const ProblemSolutionSection = () => {
  ...
  return (
    <section className="relative w-full h-auto overflow-hidden border-t border-b border-[#1a1a1a] mt-16 md:mt-24 lg:mt-[133.3px]">
      <div
        className="absolute top-0 right-0 w-1/2 h-full 
      bg-[linear-gradient(180deg,rgba(0,0,0,0)_0%,rgba(121,24,0,1)_53%,rgba(241,48,0,1)_100%)]
       "
      />
        <img
          src="/images/fleetgrid.svg"
          className="absolute top-0 left-0 w-full object-cover hidden lg:block"
          alt="Frame"
        />
      <div className="grid grid-cols-1 lg:grid-cols-2 h-full mt-[-140px]">
        <div className="relative bg-black lg:border-r border-[#1a1a1a] flex flex-col">
          <div className="flex flex-col mt-16 md:mt-20 lg:mt-[609px]">
        ...
        <div className="relative flex flex-col ">
          <div className="flex items-center gap-2 absolute top-4 md:top-8 lg:top-[652px] left-4 md:left-8  lg:left-[53px] mt-[-40px]">
          ...
          <div className="flex flex-col mt-16 md:mt-20 lg:mt-[678px]">
